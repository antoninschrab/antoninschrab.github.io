...
The third one is [Efficient Aggregated Kernel Tests using Incomplete U-statistics](https://arxiv.org/pdf/2206.09194.pdf) where we propose computationally efficient tests for the two-sample, goodness-of-fit, and independence problems, this last one consists in detecting dependence between the two components of paired samples.
